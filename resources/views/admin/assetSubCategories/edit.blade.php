...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.asset-sub-categories.update", [$assetSubCategory->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asset_subcategory') ? 'is-invalid' : '' }}" type="text" name="asset_subcategory" id="asset_subcategory" value="{{ old('asset_subcategory', $assetSubCategory->asset_subcategory) }}" required>
