    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.periods.update", [$period->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period') ? 'is-invalid' : '' }}" type="text" name="period" id="period" value="{{ old('period', $period->period) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value') ? 'is-invalid' : '' }}" type="number" name="value" id="value" value="{{ old('value', $period->value) }}" step="1" required>
                @if($errors->has('value'))
