    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.asset-locations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_cee') ? 'is-invalid' : '' }}" type="text" name="name_cee" id="name_cee" value="{{ old('name_cee', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('altitude') ? 'is-invalid' : '' }}" type="number" name="altitude" id="altitude" value="{{ old('altitude', '') }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('local_hour') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="local_hour" id="local_hour" value="1" {{ old('local_hour', 0) == 1 ? 'checked' : '' }}>
