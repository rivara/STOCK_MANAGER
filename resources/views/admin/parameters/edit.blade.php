        ...
        <form method="POST" action="{{ route("admin.parameters.update", [$parameter->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $parameter->active || old('active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('period') ? 'is-invalid' : '' }}" type="number" name="period" id="period" value="{{ old('period', $parameter->period) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('decimals') ? 'is-invalid' : '' }}" type="number" name="decimals" id="decimals" value="{{ old('decimals', $parameter->decimals) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_value') ? 'is-invalid' : '' }}" type="number" name="max_value" id="max_value" value="{{ old('max_value', $parameter->max_value) }}" step="0.0001">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('min_value') ? 'is-invalid' : '' }}" type="text" name="min_value" id="min_value" value="{{ old('min_value', $parameter->min_value) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $parameter->start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $parameter->end_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('formula') ? 'is-invalid' : '' }}" type="text" name="formula" id="formula" value="{{ old('formula', $parameter->formula) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('alarm') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="alarm" id="alarm" value="1" {{ $parameter->alarm || old('alarm', 0) === 1 ? 'checked' : '' }} required>
