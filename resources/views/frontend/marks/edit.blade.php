    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.marks.update", [$mark->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="mark">{{ trans('cruds.mark.fields.mark') }}</label>
                            <input class="form-control" type="text" name="mark" id="mark" value="{{ old('mark', $mark->mark) }}" required>
                            @if($errors->has('mark'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $mark->description) }}">
