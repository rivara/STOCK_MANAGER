    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.incidences-categories.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="incidence_category">{{ trans('cruds.incidencesCategory.fields.incidence_category') }}</label>
                            <input class="form-control" type="text" name="incidence_category" id="incidence_category" value="{{ old('incidence_category', '') }}" required>
