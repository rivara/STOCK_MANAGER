                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.units.update", [$unit->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="unit" id="unit" value="{{ old('unit', $unit->unit) }}" required>
                            @if($errors->has('unit'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $unit->description) }}">
