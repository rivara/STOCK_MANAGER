    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.networks.update", [$network->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="network">{{ trans('cruds.network.fields.network') }}</label>
                            <input class="form-control" type="text" name="network" id="network" value="{{ old('network', $network->network) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $network->description) }}">
