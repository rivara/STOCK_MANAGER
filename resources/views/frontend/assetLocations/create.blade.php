                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.asset-locations.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name_cee" id="name_cee" value="{{ old('name_cee', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="longitude" id="longitude" value="{{ old('longitude', '') }}" step="0.000001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="latitude" id="latitude" value="{{ old('latitude', '') }}" step="0.000001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="altitude" id="altitude" value="{{ old('altitude', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="local_hour" id="local_hour" value="1" {{ old('local_hour', 0) == 1 ? 'checked' : '' }}>
