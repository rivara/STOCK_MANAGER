    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.calculations.update", [$calculation->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="calculation">{{ trans('cruds.calculation.fields.calculation') }}</label>
                            <input class="form-control" type="text" name="calculation" id="calculation" value="{{ old('calculation', $calculation->calculation) }}" required>
