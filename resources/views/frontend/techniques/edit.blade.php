    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.techniques.update", [$technique->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="idtechnique">{{ trans('cruds.technique.fields.idtechnique') }}</label>
                            <input class="form-control" type="number" name="idtechnique" id="idtechnique" value="{{ old('idtechnique', $technique->idtechnique) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="technique" id="technique" value="{{ old('technique', $technique->technique) }}" required>
