                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.assets-histories.update", [$assetsHistory->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $assetsHistory->start_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $assetsHistory->end_date) }}">
