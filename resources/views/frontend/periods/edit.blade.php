    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.periods.update", [$period->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="period">{{ trans('cruds.period.fields.period') }}</label>
                            <input class="form-control" type="text" name="period" id="period" value="{{ old('period', $period->period) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="value" id="value" value="{{ old('value', $period->value) }}" step="1" required>
                            @if($errors->has('value'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('value') }}
                                </div>
