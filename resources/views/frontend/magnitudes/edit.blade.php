    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.magnitudes.update", [$magnitude->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="idmagnitude">{{ trans('cruds.magnitude.fields.idmagnitude') }}</label>
                            <input class="form-control" type="number" name="idmagnitude" id="idmagnitude" value="{{ old('idmagnitude', $magnitude->idmagnitude) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="magnitude" id="magnitude" value="{{ old('magnitude', $magnitude->magnitude) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $magnitude->description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="high" id="high" value="{{ old('high', $magnitude->high) }}" step="1">
                            @if($errors->has('high'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('high') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="low" id="low" value="{{ old('low', $magnitude->low) }}" step="1">
                            @if($errors->has('low'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('low') }}
                                </div>
