    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.parameters.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="decimals" id="decimals" value="{{ old('decimals', '0') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_value" id="max_value" value="{{ old('max_value', '') }}" step="0.0001">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="min_value" id="min_value" value="{{ old('min_value') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="formula" id="formula" value="{{ old('formula', '') }}">
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="alarm" id="alarm" value="1" required {{ old('alarm', 0) == 1 ? 'checked' : '' }}>
