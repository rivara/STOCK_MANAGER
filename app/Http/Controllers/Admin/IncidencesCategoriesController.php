...
class IncidencesCategoriesController extends Controller
{
    public function index()
    {
        ...
        return view('admin.incidencesCategories.index', compact('incidencesCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.incidencesCategories.create');
    }
    ...
    public function store(StoreIncidencesCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.incidences-categories.index');
    }
    ...
    public function edit(IncidencesCategory $incidencesCategory)
    {
        ...
        return view('admin.incidencesCategories.edit', compact('incidencesCategory'));
    }
    ...
    public function show(IncidencesCategory $incidencesCategory)
    {
        ...
        return view('admin.incidencesCategories.show', compact('incidencesCategory'));
    }
