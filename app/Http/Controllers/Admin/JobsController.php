...
class JobsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.jobs.index', compact('jobs', 'task_tags', 'marks', 'samples'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.jobs.create', compact('types', 'marks', 'samples'));
    }
    ...
    public function edit(Job $job)
    {
        ...
        return view('admin.jobs.edit', compact('types', 'marks', 'samples', 'job'));
    }
