...
class IncidencesSubcategoriesController extends Controller
{
    public function index()
    {
        ...
        return view('admin.incidencesSubcategories.index', compact('incidencesSubcategories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.incidencesSubcategories.create', compact('incidence_categories'));
    }
    ...
    public function store(StoreIncidencesSubcategoryRequest $request)
    {
        ...
        return redirect()->route('admin.incidences-subcategories.index');
    }
    ...
    public function edit(IncidencesSubcategory $incidencesSubcategory)
    {
        ...
        return view('admin.incidencesSubcategories.edit', compact('incidence_categories', 'incidencesSubcategory'));
    }
    ...
    public function show(IncidencesSubcategory $incidencesSubcategory)
    {
        ...
        return view('admin.incidencesSubcategories.show', compact('incidencesSubcategory'));
    }
