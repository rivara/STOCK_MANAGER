...
class AssetSubCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.assetSubCategories.index', compact('assetSubCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.assetSubCategories.create', compact('asset_categories'));
    }
    ...
    public function store(StoreAssetSubCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.asset-sub-categories.index');
    }
    ...
    public function edit(AssetSubCategory $assetSubCategory)
    {
        ...
        return view('frontend.assetSubCategories.edit', compact('asset_categories', 'assetSubCategory'));
    }
    ...
    public function show(AssetSubCategory $assetSubCategory)
    {
        ...
        return view('frontend.assetSubCategories.show', compact('assetSubCategory'));
    }
