...
class MarksController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.marks.index', compact('marks'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.marks.create');
    }
    ...
    public function store(StoreMarkRequest $request)
    {
        ...
        return redirect()->route('frontend.marks.index');
    }
    ...
    public function edit(Mark $mark)
    {
        ...
        return view('frontend.marks.edit', compact('mark'));
    }
    ...
    public function show(Mark $mark)
    {
        ...
        return view('frontend.marks.show', compact('mark'));
    }
