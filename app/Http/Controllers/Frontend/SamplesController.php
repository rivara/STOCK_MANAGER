...
class SamplesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.samples.index', compact('samples'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.samples.create', compact('marks'));
    }
    ...
    public function edit(Sample $sample)
    {
        ...
        return view('frontend.samples.edit', compact('marks', 'sample'));
    }
