...
class AssetLocationApiController extends Controller
{
    public function index()
    {
        ...
        return new AssetLocationResource(AssetLocation::with(['network', 'zone', 'area', 'province', 'municipality', 'record'])->get());
    }
    ...
    public function show(AssetLocation $assetLocation)
    {
        ...
        return new AssetLocationResource($assetLocation->load(['network', 'zone', 'area', 'province', 'municipality', 'record']));
    }
